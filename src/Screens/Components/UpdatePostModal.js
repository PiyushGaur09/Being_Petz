    ...
    if (postData) {
      setFormData({
        ...
        featured_image: postData.featured_image
          ? {
              uri: `https://beingpetz.com/petz-info/public/${postData.featured_image}`,
              name: 'featured.jpg',
              type: 'image/jpeg',
            }
          : postData?.repost?.featured_image
          ? {
              uri: `https://beingpetz.com/petz-info/public/${postData?.repost?.featured_image}`,
              name: 'featured.jpg',
              type: 'image/jpeg',
            }
          : null,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://beingpetz.com/petz-info/public/api/v1/post/update',
        data,
        config,
      );
