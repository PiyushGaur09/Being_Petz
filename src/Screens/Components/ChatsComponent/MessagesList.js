...
//           'https://argosmob.uk/being-petz/public/api/v1/community/message/like-unlike',
//           formData,
//           {
//             headers: {
...
//       const senderImage = `https://argosmob.uk/being-petz/public/${item.user?.profile}`;
...
//                         <Image
//                           source={{
//                             uri: `https://argosmob.uk/being-petz/public/${item.old_message.media_path}`,
//                           }}
...
//                         const response = await axios.post(
//                           'https://argosmob.uk/being-petz/public/api/v1/community/delete-message-for-all',
//                           formData,
//                           {
//                             headers: {
//                               'Content-Type': 'multipart/form-data',
...
//                         const response = await axios.post(
//                           'https://argosmob.uk/being-petz/public/api/v1/community/delete-message-for-me',
//                           formData,
//                           {
//                             headers: {
//                               'Content-Type': 'multipart/form-data',
...
//         <Image
//           source={{
//             uri: `https://argosmob.uk/being-petz/public/${item.media_path}`,
//           }}
//           style={styles.image}
//           resizeMode="cover"
//         />
