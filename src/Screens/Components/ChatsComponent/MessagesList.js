  ...
  ({ messages, currentUserId, onVotePoll, communityId }, ref) => {
    ...
    const handleLikeUnlike = async messageId => {
      try {
        ...
        const response = await axios.post(
          'https://beingpetz.com/petz-info/public/api/v1/community/message/like-unlike',
          formData,
          {
            headers: {
    ...
    const handleSendReply = async () => {
      ...
      try {
        ...
        const response = await axios.post(
          'https://beingpetz.com/petz-info/public/api/v1/community/send-message',
          formData,
          {
            headers: {
              'Content-Type': 'multipart/form-data',
    ...
    const renderMessage = ({ item }) => {
      ...
      const senderImage = `https://beingpetz.com/petz-info/public/${item.user?.profile}`;
                  ...
                  <View style={styles.replyContainer}>
                    <View style={styles.originalMessageContainer}>
                      ...
                      {item.old_message.message_type === 'image' && (
                        <Image
                          source={{
                            uri: `https://beingpetz.com/petz-info/public/${item.old_message.media_path}`,
                          }}
                  ...
                  <TouchableOpacity
                    ...
                    onPress={async () => {
                      try {
                        ...
                        const response = await axios.post(
                          'https://beingpetz.com/petz-info/public/api/v1/community/delete-message-for-all',
                          formData,
                          {
                            headers: {
                              'Content-Type': 'multipart/form-data',
                  ...
                  <TouchableOpacity
                    ...
                    onPress={async () => {
                      try {
                        ...
                        const response = await axios.post(
                          'https://beingpetz.com/petz-info/public/api/v1/community/delete-message-for-me',
                          formData,
                          {
                            headers: {
                              'Content-Type': 'multipart/form-data',
  ...
  return (
    <>
      ...
      >
        <Image
          source={{
            uri: `https://beingpetz.com/petz-info/public/${item.media_path}`,
          }}
          style={styles.image}
          resizeMode="cover"
        />
