...
//       Alert.alert('Error', error.message || 'Failed to update community profile');
//     } finally {
//       setUploading(false);
//     }
//   };
...
//       communityData.members?.filter(m => m.role === 'moderator') || [];
//     const adminId = communityData.creator?.id;
//     const isAdmin = currentUserId === adminId || currentUserRole === 'super_admin';
...
//       {/* Header with Avatar */}
//       <View style={styles.header}>
//         {(currentUserRole === 'admin' || currentUserRole === 'super_admin') && isEditing ? (
//           <TouchableOpacity onPress={handleChooseImage}>
//             {imageUri || communityData.profile ? (
//               <Image
//                 source={{
//                   uri: imageUri || `https://argosmob.com/being-petz/public/${communityData.profile}`,
//                 }}
//                 style={styles.communityAvatar}
//               />
//             ) : (
//               <View style={[styles.communityAvatar, styles.placeholderCommunityAvatar]}>
//                 <FontAwesome name="users" size={40} color="#8337B2" />
//               </View>
//             )}
...
//         <Text style={styles.communityType}>
//           {communityData.type === 'public' ? 'Public Community' : 'Private Community'}
//         </Text>
      ...
      <View style={styles.actionsContainer}>
        ...
        <TouchableOpacity
          ...
          {exitLoading ? (
            ...
            <>
              <Feather name="log-out" size={20} color="white" />
              <Text style={[styles.actionButtonText,{marginLeft:10}]}>Exit Community</Text>
            </>
          )}
        </TouchableOpacity>
      </View>
