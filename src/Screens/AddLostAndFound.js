...
// const BASE_URL = 'https://argosmob.uk/being-petz/public/api/v1';
...
//             onPress: () => {
//               navigation.goBack();
//               route.params?.onRefresh?.(); // optional: trigger a refresh callback
//             },
//           },
//         ]);
//       } else {
...
//   // Get the current breed options based on selected pet type
//   const currentBreedOptions = breedData[formData.pet_type] || [];
...
//         <Picker
//           mode="dropdown"
//           selectedValue={formData.pet_gender}
//           onValueChange={value => handleInputChange('pet_gender', value)}
//           style={styles.picker}>
...
//       {/* Conditionally render Date of Birth only for "lost" reports */}
...
//             onValueChange={value => handleInputChange('isVaccinated', value)}
//             style={styles.picker}>
...
//           <Picker
//             mode="dropdown"
//             selectedValue={formData.isDewormed}
//             onValueChange={value => handleInputChange('isDewormed', value)}
//             style={styles.picker}>
//             <Picker.Item label="Yes" value="0" />
//             <Picker.Item label="No" value="1" />
//           </Picker>
...
//           <Picker
//             mode="dropdown"
//             selectedValue={formData.isHealthy}
//             onValueChange={value => handleInputChange('isHealthy', value)}
//             style={styles.picker}>
//             <Picker.Item label="Yes" value="0" />
//             <Picker.Item label="No" value="1" />
//           </Picker>
...
//           {formData.report_type === 'lost' ? 'Date Lost' : 'Date Found'}
//         </Text>
//         <TouchableOpacity
//           style={styles.dateInput}
//           onPress={() => {
