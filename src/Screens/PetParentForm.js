...
const PetParentForm = ({route}) => {
  ...
  console.log('profile picture', profileUploaded);
  ...
  const updateProfilePic = async (userId, imageUri) => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://beingpetz.com/petz-info/public/api/v1/auth/update-profile-picture',
        form,
        {headers: {'Content-Type': 'multipart/form-data'}},
      );
  ...
  const deleteProfilePicture = async () => {
    try {
      ...
      const response = await axios.post(
        'https://beingpetz.com/petz-info/public/api/v1/auth/delete-profile-picture',
        form,
        {headers: {'Content-Type': 'multipart/form-data'}},
      );
  ...
  const handleUpdateProfile = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://beingpetz.com/petz-info/public/api/v1/auth/update-profile',
        data,
        {
          headers: {
